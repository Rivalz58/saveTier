...
const AdminUserManagement: React.FC = () => {
  ...
  const [modalAction, setModalAction] = useState<'quarantine' | 'delete' | 'role'>('quarantine');
  ...
  const openConfirmationModal = (action: 'quarantine' | 'delete' | 'role', user: User) => {
      ...
      <div className="admin-toolbar">
        ...
        <div className="admin-filters">
          ...
          >
            ...
            {roles.map(role => (
              <option key={role.id} value={role.id.toString()}>{role.libelle}</option>
            ))}
          </select>
        ...
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            {modalAction === 'role' && (
              <div>
                <p>
                  Sélectionnez le rôle à ajouter à l'utilisateur <strong>{selectedUser?.username}</strong> :
                </p>
                <select 
                  value={selectedRole || ''} 
            ...
            <div className="modal-actions">
              ...
              <button 
                ...
                disabled={(modalAction === 'role' && !selectedRole) || isActionLoading}
              >
