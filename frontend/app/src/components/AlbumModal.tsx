...
const AlbumModal: React.FC<AlbumModalProps> = ({
  ...
  const [selectedOption, setSelectedOption] = useState<
    "tierlist" | "tournoi" | "classement" | null
  >(null);
  ...
  return (
    ...
    >
      ...
      <p className="album-modal-subtitle">
        Que souhaitez-vous créer avec cet album ?
      </p>
      ...
      {!isUserLoggedIn && selectedOption && (
        <div className="login-message">
          <p>
            Vous n'êtes pas connecté ! Vous pourrez créer un {selectedOption}{" "}
            mais ne pourrez pas l'enregistrer.
          </p>
