    ...
    <footer className="footer-container">
      <div className="footer-content">
        <div className="footer-section about">
          ...
          <p>Créez et partagez des tierlist, tournois et classements pour vos passions.</p>
        </div>
        
        <div className="footer-section links">
          <h3>Liens rapides</h3>
          <ul>
            <li><Link to="/tierlists">Tierlists</Link></li>
            <li><Link to="/tournois">Tournois</Link></li>
            <li><Link to="/classements">Classements</Link></li>
            <li><Link to="/allalbum">Albums</Link></li>
          </ul>
        </div>
        ...
        <div className="footer-section contact">
          ...
          <a href="mailto:contact@tierhub.com" className="contact-link">contact@tierhub.com</a>
        </div>
      </div>
