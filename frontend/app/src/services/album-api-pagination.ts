...
export const getPaginatedAlbums = async (params: AlbumQueryParams): Promise<PaginatedAlbums> => {
  try {
...
export const getCategoriesWithCount = async (): Promise<{name: string, count: number}[]> => {
  try {
