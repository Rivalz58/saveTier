      ...
      <div className="page-content">
        <Routes>
          ...
          <Route
            path="/login"
            element={
              <Login setUser={setUser} updateUserStatus={updateUserStatus} />
            }
          />
          <Route
            path="/register"
            element={
              <Register setUser={setUser} updateUserStatus={updateUserStatus} />
            }
          />
          ...
          <Route
            ...
            element={
              user && isAdmin ? (
                <AlbumEditor user={user} isAdmin={isAdmin} />
              ) : (
                <Navigate to="/" />
              )
            }
          ...
          <Route
            path="/album/edit/:id"
            element={
              user ? <AlbumEditor user={user} /> : <Navigate to="/login" />
            }
          />
          ...
          <Route
            path="/tierlists/create/editor"
            element={<TierListEditor user={user} />}
          />
          <Route
            path="/tournois/create/editor"
            element={<TournamentEditor user={user} />}
          />
          <Route
            path="/classements/create/editor"
            element={<RankingEditor user={user} />}
          />

          {/* Routes pour visualiser et éditer les contenus existants */}
          <Route
            path="/tierlists/edit/:id"
            element={<TierListEditor user={user} />}
          />
          <Route
            path="/tierlists/:id"
            element={<TierlistViewer user={user} />}
          />
          ...
          <Route
            path="/tournois/:id"
            element={<TournamentViewer user={user} />}
          />

          <Route
            path="/classements/edit/:id"
            element={<RankingEditor user={user} />}
          />
          <Route
            path="/classements/:id"
            element={<RankingViewer user={user} />}
          />
